...
export const mockProject: ProjectData = {
  ...
  discovery: {
    problem: 'Students struggle to find reliable, compatible teammates for high-stakes projects, leading to abandoned hackathons, unequal workloads, and delayed portfolios.',
    target_user: 'Undergraduate and graduate students building software, hardware, design, or research projects outside standard classroom silos.',
    context: 'Traditional campus channels (Discord servers, WhatsApp groups, class forums) have high noise, zero accountability, and no compatibility vetting.',
    constraints: [
      'Zero-cost tier for students',
      'Mobile-first on-the-go experience',
      'Low friction onboarding (< 2 minutes)',
    ],
    known_value: 'Direct pairing on verified working styles (e.g. night-owl vs early-bird, sprint vs steady pace) reduces team failure by 78%.',
    open_questions: [
      'How to verify skills without intimidating beginner freshmen?',
      'Best mechanism for student safety and campus email authentication?',
    ],
  },
  positioning: {
